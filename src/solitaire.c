...
#define SELECTOR_ROW_TOP FLAG_OFF
#define SELECTOR_ROW_TABLEAU FLAG_ON
#define TOP_PILE_STOCK FLAG_OFF
#define TOP_PILE_WASTE FLAG_ON
#define TOP_PILE_FOUNDATION_FIRST 2
#define CARD_FACE_DOWN FLAG_OFF
#define CARD_FACE_UP FLAG_ON
#define CARD_SUIT_BLACK_START 2
#define CARD_RANK_ACE FLAG_OFF
#define CARD_RANK_KING (CARD_RANK_COUNT - 1)
#define DEAL_WITH_ANIMATION FLAG_ON
#define INVALID_MOVE_BLINKS 2
#define INVALID_MOVE_BLINK_FRAMES 4
#define SELECTOR_COL_MIN FLAG_OFF
#define MOUSE_ROW_SPLIT_Y 4
#define MOUSE_Y_DIRECTION 1
#define NO_TABLEAU_DEPTH U8_MAX_VALUE
#define SCREEN_PIXEL_W 640
#define SCREEN_PIXEL_H 480
#define TILE_PIXELS 16
#define TILE_CENTER_OFFSET 8
#define WIN_MESSAGE_Y 14
#define WIN_RESTART_Y 15
